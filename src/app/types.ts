...
export const MODERATION_CATEGORIES = [
  // Content inappropriate for an educational, student-safe environment
  "INAPPROPRIATE",
  // Content that is off-topic for English learning or derails the lesson
  "OFF_TOPIC",
  // Content primarily in a non-English language when English practice is expected
  "NON_ENGLISH",
  // Default when message is acceptable
  "NONE",
] as const;
